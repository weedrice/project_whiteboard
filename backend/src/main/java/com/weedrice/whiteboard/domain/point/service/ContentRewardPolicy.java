...
public enum ContentRewardPolicy {
    ...
    ATTENDANCE_STREAK_7("POINT_ATTENDANCE_STREAK_7_REWARD", 30, "ATTENDANCE", "7일 연속 출석 보너스", "7일 연속 출석 보상 회수"),
    ATTENDANCE_STREAK_30("POINT_ATTENDANCE_STREAK_30_REWARD", 100, "ATTENDANCE", "30일 연속 출석 보너스", "30일 연속 출석 보상 회수");
