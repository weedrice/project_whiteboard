...
public interface MessageRepository extends JpaRepository<Message, Long>, MessageRepositoryCustom {
    ...
    default Optional<Message> findDeletableByMessageIdForUpdate(Long userId, Long messageId) {
        return findDeletableByMessageIdInForUpdate(userId, List.of(messageId)).stream()
                .findFirst();
    }
}
