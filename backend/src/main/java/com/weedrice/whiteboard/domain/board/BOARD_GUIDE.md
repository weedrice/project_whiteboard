...
## 1. 주요 기능 및 로직
- 스페이스 목록: 활성·인기·전체 스페이스 목록을 조회하고 구독 여부, 관리자 표시명, 게시글·구독자 수 등을 반환합니다. 전체 목록은 슈퍼 관리자만 조회할 수 있습니다.
- 스페이스 상세: 관리자 여부·구독 여부·카테고리·최신 게시글 15개를 함께 반환합니다. 비활성 또는 비공개 스페이스는 해당 스페이스의 활성 관리자 또는 사용 가능한 슈퍼 관리자만 조회할 수 있습니다.
