...
class HomeLandingServiceTest {
    ...
    void getLanding_returnsCuratedPosts() {
        ...
        when(postListReadService.getTrendingFeedPosts(any(), eq(1L), eq("24h"))).thenReturn(curatedPosts);
        when(postListReadService.getPublicLandingLatestFeedPosts(any(), eq(1L))).thenReturn(latestPosts);
        ...
        verify(postListReadService).getPublicLandingLatestFeedPosts(any(), eq(1L));
    }
    ...
    void getLanding_returnsEmptyArraysForNullSources() {
        when(postListReadService.getTrendingFeedPosts(any(), isNull(), eq("24h"))).thenReturn(null);
        when(postListReadService.getPublicLandingLatestFeedPosts(any(), isNull())).thenReturn(null);
    ...
    void getLanding_propagatesCuratedPostFailures() {
        when(postListReadService.getTrendingFeedPosts(any(), isNull(), eq("24h")))
        ...
        verify(postListReadService, never()).getPublicLandingLatestFeedPosts(any(), any());
    ...
    void getLanding_propagatesStatsFailures() {
        when(postListReadService.getTrendingFeedPosts(any(), isNull(), eq("24h"))).thenReturn(List.of());
        when(postListReadService.getPublicLandingLatestFeedPosts(any(), isNull())).thenReturn(List.of());
