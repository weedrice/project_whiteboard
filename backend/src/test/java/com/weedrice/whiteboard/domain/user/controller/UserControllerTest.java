...
class UserControllerTest {
    ...
    class MyInfoTests {
        ...
        void getMyInfo_success() {
            ...
            // when
            ResponseEntity<ApiResponse<MyInfoResponse>> response = userController.getMyInfo(customUserDetails);
            ...
            assertThat(response.getBody().getData().isEmailVerified()).isTrue();
        }
        ...
        void updateMyProfile_success() {
            ...
            given(userService.updateMyProfile(eq(1L), eq("Updated Name"), eq("https://example.com/image.jpg"), eq(100L)))
                    .willReturn(updatedUser);

            // when
            ResponseEntity<ApiResponse<UpdateProfileResponse>> response =
                    userController.updateMyProfile(request, customUserDetails);
        ...
        void updatePassword_success() {
            ...
            ResponseEntity<ApiResponse<MessageResponse>> response =
                    userController.updatePassword(request, customUserDetails);
        ...
        void deleteAccount_success() {
            ...
            // when
            ResponseEntity<ApiResponse<MessageResponse>> response =
                    userController.deleteAccount(request, customUserDetails);
    ...
    class UserProfileTests {
        ...
        void getUserProfile_success() {
            ...
            // when
            ResponseEntity<ApiResponse<UserProfileResponse>> response = userController.getUserProfile(targetUserId);
    ...
    class SettingsTests {
        ...
        void getMySettings_success() {
            ...
            // when
            ResponseEntity<ApiResponse<UserSettingsResponse>> response =
                    userController.getMySettings(customUserDetails);
        ...
        void updateMySettings_success() {
            ...
            given(userSettingsService.updateSettings(eq(1L), eq("DARK"), eq("en"), eq("America/New_York"), eq(false)))
                    .willReturn(updatedSettings);

            // when
            ResponseEntity<ApiResponse<UserSettingsResponse>> response =
                    userController.updateMySettings(request, customUserDetails);
        ...
        void getMyNotificationSettings_success() {
            ...
            // when
            ResponseEntity<ApiResponse<List<NotificationSettingResponse>>> response =
                    userController.getMyNotificationSettings(customUserDetails);
        ...
        void updateMyNotificationSetting_success() {
            ...
            // when
            ResponseEntity<ApiResponse<NotificationSettingResponse>> response =
                    userController.updateMyNotificationSetting(request, customUserDetails);
    ...
    class BlockUserTests {
        ...
        void blockUser_success() {
            ...
            // when
            ResponseEntity<ApiResponse<MessageResponse>> response =
                    userController.blockUser(targetUserId, customUserDetails);
        ...
        void unblockUser_success() {
            ...
            // when
            ResponseEntity<ApiResponse<MessageResponse>> response =
                    userController.unblockUser(targetUserId, customUserDetails);
        ...
        void getBlockedUsers_success() {
            ...
            // when
            ResponseEntity<ApiResponse<PageResponse<BlockedUserResponse>>> response =
                    userController.getBlockedUsers(pageable, customUserDetails);

            // then
            assertThat(response.getStatusCode().value()).isEqualTo(200);
            assertThat(response.getBody().isSuccess()).isTrue();
            assertThat(response.getBody().getData().getContent()).hasSize(1);
            assertThat(response.getBody().getData().getContent().get(0).getLoginId()).isEqualTo("blockeduser");
        }
    }
    ...
    class ActivityTests {
        ...
        void getMySubscriptions_success() {
            ...
            BoardResponse boardResponse = new BoardResponse(
                    board, 100L, "Admin User", 1L, false, true, Collections.emptyList(), Collections.emptyList()
            );
            ...
            // when
            ApiResponse<PageResponse<BoardResponse>> response =
                    userController.getMySubscriptions(customUserDetails, pageable);
        ...
        void getMyPosts_success() {
            ...
            // when
            ApiResponse<PageResponse<PostSummary>> response =
                    userController.getMyPosts(customUserDetails, pageable);
        ...
        void getMyComments_success() {
            ...
            // when
            ApiResponse<PageResponse<com.weedrice.whiteboard.domain.comment.dto.MyCommentResponse>> response =
                    userController.getMyComments(customUserDetails, pageable);
        ...
        void getRecentlyViewedPosts_success() {
            ...
            // when
            ApiResponse<PageResponse<PostSummary>> response =
                    userController.getRecentlyViewedPosts(customUserDetails, pageable);
