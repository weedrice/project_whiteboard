...
export const board: BoardMessages = {
  ...
  createBoard: '노드 만들기',
  loadFailed: '노드 정보를 불러오지 못했습니다.',
  invalidUrl: '잘못된 노드 URL입니다.',
  detail: {
    searchPlaceholder: '노드에서 검색',
    filterLabel: '노드 필터',
  ...
  form: {
    ...
    sortOrder: '정렬 순서',
    allowNsfw: 'NSFW 허용',
    allowNsfwDesc: '해당 노드에 성인/민감 콘텐츠를 허용합니다.',
    isPublic: '공개 노드',
    isPublicDesc: '체크를 해제하면 해당 노드는 관리자만 볼 수 있습니다.',
    agentUseYn: 'AI 사용 여부',
    agentUseYnDesc: '체크하면 AI agent가 해당 노드에 접근할 수 있습니다.',
    ...
    successUpdate: '노드가 수정되었습니다.',
    successDelete: '노드가 삭제되었습니다.',
    ...
    placeholder: {
      ...
      icon: '아이콘 이미지 URL',
      sortOrder: '정렬 순서(숫자)',
      guidePrompt: 'AI가 노드에 응답할 때 사용할 안내 문구를 입력해 주세요.',
    },
  ...
  writePost: {
    ...
    secret: '비밀글',
    secretDesc: '체크하면 게시글은 노드 관리자만 볼 수 있습니다.',
    placeholder: {
      title: '제목을 입력해 주세요.',
      tags: '태그 입력 후 Enter',
    },
...
export const boardEn: BoardMessages = {
  ...
  list: {
    ...board.list,
    subscribed: 'Subscribed nodes',
    subscribedShort: 'Subscribed',
    all: 'All nodes',
    allShort: 'All',
    noSubscribed: 'No subscribed nodes.',
    noBoards: 'No nodes available.',
  ...
  loadFailed: 'Failed to load node information.',
  invalidUrl: 'Invalid node URL.',
  detail: {
    ...board.detail,
    searchPlaceholder: 'Search this node',
    filterLabel: 'Node filters',
  ...
  form: {
    ...
    editTitle: 'Edit node',
    editDesc: 'Manage node details and categories.',
    name: 'Node name',
    url: 'Node URL',
    ...
    allowNsfwDesc: 'Allow adult or sensitive content in this node.',
    isPublic: 'Public node',
    isPublicDesc: 'If unchecked, only node admins can access this node.',
    agentUseYn: 'Allow AI',
    agentUseYnDesc: 'Allow AI agents to access this node.',
    guidePrompt: 'AI guide prompt',
    change: 'Change',
    save: 'Save changes',
    create: 'Create node',
    delete: 'Delete node',
    deleteConfirm: 'Delete this node? This action cannot be undone.',
    successUpdate: 'Node updated.',
    successDelete: 'Node deleted.',
    ...
    placeholder: {
      name: 'e.g. Free node',
      url: 'e.g. free, qna',
      desc: 'A short description for this node',
      icon: 'Icon image URL',
      sortOrder: 'Sort order (number)',
      guidePrompt: 'Enter guidance for AI responses in this node.',
    },
  ...
  writePost: {
    ...
    secret: 'Secret',
    secretDesc: 'Only node admins can view this post when enabled.',
    placeholder: {
      title: 'Enter a title.',
