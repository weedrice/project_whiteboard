...
export const userEn: UserMessages = {
  ...
  settings: {
    ...
    timezoneAuto: 'Automatic (follow this device)',
    timezoneHelp: 'Posts and notifications are shown in this time zone. Service-wide rules such as attendance still follow Korean time.',
    light: 'Light',
    dark: 'Dark',
    ...
    browserPushDesc: 'Receive new notifications in this browser. Turning push off stops notifications on all devices and browsers registered to this account.',
    ...
    pushDisable: 'Disable push on all devices',
    ...
    pushDisableSuccess: 'Push notifications have been disabled on all devices and browsers registered to this account.',
    pushDisableFailed: 'Failed to disable push notifications on all devices.',
  ...
  message: {
    title: 'Send message',
    conversationTitle: 'Recent conversation with {name}',
    receiver: 'Recipient',
    content: 'Message',
    ...
    me: 'Me',
    contextEmpty: 'There are no other messages with this person.',
    loadOlder: 'Load older messages',
    scrollForOlder: 'Scroll up to load older messages.',
    newMessagesPending: '{count} new message(s). The list will update when you close this conversation.',
