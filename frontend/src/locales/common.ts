...
export const common: CommonMessages = {
  ...
  messages: {
    ...
    forbidden: '권한이 없습니다.',
    boardManageForbidden: '스페이스를 관리할 권한이 없습니다.',
    boardWriteForbidden: '이 스페이스에 글을 작성할 권한이 없습니다.',
  ...
  sent: '전송됨',
  seo: {
    description: '노비스 - 다양한 주제의 스페이스에서 인기 게시글을 발견하고, 의견을 나누는 커뮤니티. 지금 가입하고 관심 스페이스를 구독하세요.',
  },
  paginationSummary: {
    total: '총 {count}{unit}',
    itemUnit: '건',
