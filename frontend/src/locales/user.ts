...
export const user: UserMessages = {
  ...
  scrapList: {
    ...
    selectScrap: '이동할 스크랩 선택',
    destinationFolder: '이동할 폴더 선택',
    unfiled: '미분류',
    move: '이동',
    moveFailed: '스크랩을 이동하지 못했습니다. 다시 시도해 주세요.',
  },
  draftList: {
    empty: '임시저장 글이 없습니다.',
    ...
    deleteOutdated: '다른 위치에서 임시저장 글이 변경되어 삭제하지 않았습니다. 목록을 새로고침했습니다.',
  ...
  settings: {
    ...
    language: '언어',
    timezone: '표시 시간대',
    timezoneAuto: '자동 (기기 설정 따름)',
    timezoneHelp: '글과 알림의 시각을 이 시간대로 표시합니다. 출석 같은 서비스 기준 판정은 한국 시간을 따릅니다.',
    light: '라이트',
    dark: '다크',
    notifications: '알림 설정',
    like: '\uC88B\uC544\uC694',
    ...
    notificationTypes: {
      ...
      INQUIRY: {
        label: '문의',
        description: '문의 답변과 종료 알림을 받습니다.',
      },
    },
    email: '이메일 알림',
    ...
    browserPush: '브라우저 푸시',
    browserPushDesc: '이 브라우저에서 새 알림을 푸시로 받습니다. 푸시를 끄면 이 계정의 모든 기기와 브라우저에서 알림 수신이 중단됩니다.',
    ...
    pushDisable: '모든 기기에서 푸시 끄기',
    pushEnableSuccess: '브라우저 푸시를 켰습니다.',
    pushEnableFailed: '브라우저 푸시를 켜지 못했습니다.',
    pushDisableSuccess: '이 계정의 모든 기기와 브라우저에서 푸시 알림을 껐습니다.',
    pushDisableFailed: '모든 기기의 푸시 알림을 끄지 못했습니다.',
  ...
  message: {
    title: '쪽지 보내기',
    conversationTitle: '{name}님과의 최근 대화',
    receiver: '받는 사람',
    content: '내용',
    ...
    me: '나',
    contextEmpty: '이 상대와 나눈 다른 대화가 없습니다.',
    loadOlder: '이전 대화 불러오기',
    scrollForOlder: '위로 스크롤하면 이전 쪽지를 불러옵니다.',
    newMessagesPending: '새 쪽지 {count}개가 있습니다. 닫으면 목록에 반영됩니다.',
