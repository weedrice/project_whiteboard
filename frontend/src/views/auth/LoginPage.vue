      ...
      <div class="mt-6">
        ...
        <div class="mt-6 grid grid-cols-3 gap-3">
          <a href="/oauth2/authorization/google"
            ...
            class="flex justify-center items-center py-2 px-4 border nv-border rounded-md shadow-sm nv-surface nv-hover-surface transition-colors duration-200">
          ...
          <a href="/oauth2/authorization/github"
            ...
            <svg class="h-5 w-5 nv-title" fill="currentColor" viewBox="0 0 24 24"
              aria-hidden="true">
