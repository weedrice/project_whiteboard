...
<template>
  <div class="max-w-2xl mx-auto py-3 sm:py-6 md:py-8 px-3 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg transition-colors duration-200">
      <div class="px-3 py-3 sm:py-5 sm:px-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 border-b border-gray-200 dark:border-gray-700">
      ...
      <div v-if="history.length > 0" class="bg-gray-50 dark:bg-gray-900/50 px-3 py-3 sm:px-6 sm:py-4 flex justify-center">
