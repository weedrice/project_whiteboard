          ...
          <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{ t('common.key') }}</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{ t('common.description') }}</th>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{ t('common.value') }}</th>
          ...
          <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
            <div>
              <div class="mt-3 text-center sm:mt-5">
                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">{{ t('common.addConfig') }}</h3>
                <div class="mt-2">
                  <div class="space-y-4">
                    <div class="flex items-center">
                      <label class="w-20 text-sm font-medium text-gray-700 text-left mr-4">{{ t('common.key') }}</label>
                    ...
                    <div class="flex items-center">
                      <label class="w-20 text-sm font-medium text-gray-700 text-left mr-4">{{ t('common.value') }}</label>
                    ...
                    <div class="flex items-center">
                      <label class="w-20 text-sm font-medium text-gray-700 text-left mr-4">{{ t('common.description') }}</label>
