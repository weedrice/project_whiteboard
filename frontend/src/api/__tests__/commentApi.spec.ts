...
describe('commentApi', () => {
    ...
    it('calls comment endpoints with expected paths', () => {
        ...
        commentApi.likeComment(11)
        commentApi.unlikeComment(11)
        ...
        expect(apiMock.post).toHaveBeenNthCalledWith(2, '/comments/11/like')
        ...
        expect(apiMock.delete).toHaveBeenNthCalledWith(2, '/comments/11/like')
