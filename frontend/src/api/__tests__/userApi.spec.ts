...
import type { NotificationSettingsPayload } from '../user'
...
describe('userApi', () => {
    ...
    it('calls profile and settings endpoints', () => {
        ...
        const notificationData: NotificationSettingsPayload = { notificationType: 'COMMENT', isEnabled: true }
        ...
        expect(apiMock.put).toHaveBeenNthCalledWith(5, '/users/me/notification-settings/bulk', notificationBulkData)
