...
const CHECKED_DTOS: { dto: string; fields: string[]; readBy: string[] }[] = [
    ...
    { dto: 'board/dto/BoardListResponse.java', fields: ['isSubscribed', 'isActive', 'isPublic', 'isListed'], readBy: ['src/types/board.ts'] },
    { dto: 'board/dto/AdminBoardResponse.java', fields: ['isActive', 'isPublic', 'isListed'], readBy: ['src/types/board.ts'] },
    { dto: 'board/dto/BoardDetailResponse.java', fields: ['isAdmin'], readBy: ['src/types/board.ts'] },
    { dto: 'board/dto/SubscriptionBoardResponse.java', fields: ['isSubscribed', 'isActive', 'isPublic', 'isListed'], readBy: ['src/types/board.ts'] },
