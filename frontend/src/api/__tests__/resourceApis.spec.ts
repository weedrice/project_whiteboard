...
describe('boardApi', () => {
    ...
    it('calls board endpoints with correct path and payload', () => {
        ...
        expect(apiMock.put).toHaveBeenNthCalledWith(2, '/boards/categories/12', categoryUpdateData)
        ...
        expect(apiMock.put).toHaveBeenNthCalledWith(3, '/boards/subscriptions/order', ['general', 'tech'])
    })
})
