...
describe('postApi', () => {
    ...
    it('calls post endpoints with correct path and payload', () => {
        ...
        postApi.updateViewHistory(3, { lastReadCommentId: 9, durationMs: 30000 }, requestConfig)
        postApi.getPostVersions(3, requestConfig)
        postApi.likePost(3)
        ...
        expect(apiMock.put).toHaveBeenNthCalledWith(2, '/posts/3/history', { lastReadCommentId: 9, durationMs: 30000 }, requestConfig)
