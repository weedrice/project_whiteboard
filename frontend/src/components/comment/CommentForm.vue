    ...
    <div class="mt-3 flex items-center justify-between">
      ...
      <div>
        <button
          ...
          class="inline-flex items-center justify-center px-2 py-1.5 sm:px-3 sm:py-1.5 text-xs sm:text-sm nv-text-muted nv-hover-surface hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition-colors"
          :class="{ 'text-indigo-600 dark:text-indigo-400 nv-active-surface': showEmoticonPicker }"
