  ...
  <div class="tiptap-toolbar flex flex-col gap-2 border-b border-[var(--nv-line)] bg-[var(--nv-surface-alt)] p-2">
    <div class="tiptap-toolbar-row tiptap-toolbar-row--scrollable">
      <div class="tiptap-toolbar-group tiptap-toolbar-group--format">
        ...
        <input type="color" name="editorToolbarTextColor" autocomplete="off" :value="currentTextColor || '#000000'" class="tiptap-color-input h-11 w-11 cursor-pointer" :aria-label="t('board.writePost.toolbar.customColor')" @input="emit('custom-text-color', ($event.target as HTMLInputElement).value)">
