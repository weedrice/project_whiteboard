            ...
            VitePWA({
                ...
                injectManifest: {
                    globPatterns: [
                        ...
                        'js/{index,HomeFeed,auth,BaseButton,BaseSegmentedControl,BaseSkeleton,BaseSpinner,comment,EmptyState,emoticon,imageFallback,keyboard,logger,message,notification,PullToRefresh,postViewModel,rolldown-runtime,sanitize,theme,useAttendance,useEventListener,useFocusTrap,useNotification,vendor-vue,vendor-query,vendor-i18n,vendor-http,vendor-icons,vendor-core}-*.js',
                    ],
                },
            }),
