...
**NoviIs**는 Vue 3와 Spring Boot (Java 21)를 기반으로 구축된 모던 커뮤니티 플랫폼입니다. 사용자 친화적인 인터페이스와 강력한 관리 기능을 제공하며, 노드, 게시글, 댓글, 알림 등 커뮤니티의 핵심 기능을 모두 갖추고 있습니다.
...
-   **Features**: 인증, 노드/게시글/댓글 관리, 알림(SSE), 관리자 기능 등

### [Frontend](./frontend/README.md)
Vue 3 기반의 반응형 웹 애플리케이션입니다.
-   **Tech**: Vue 3, Vite, TypeScript, Pinia, TailwindCSS
-   **Features**: 사용자 UI, 노드 탐색, 에디터, 실시간 알림, 다크 모드 등
